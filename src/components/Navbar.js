            ...
            <body className="bg-blue-500 sticky">
                <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                    ...
                    <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                        <li><a href="#" className="text-sm text-gray-400 hover:text-gray-500">Home</a></li>
                    ...
                    <a href="#" className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200">Sign In</a>
                    <a href="#" className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm- text-white font-bold rounded-xl transition duration-200">Register</a>
                </nav>
                ...
                <div className="navbar-menu relative z-50 hidden">
                    ...
                    <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                        ...
                        <div className="mt-auto">
                            <div className="pt-6">
                                <a href="#" className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold  bg-gray-50 hover:bg-gray-100 rounded-xl">Sign In</a>
                                <a href="#" className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700 rounded-xl">Register</a>
                            </div>
